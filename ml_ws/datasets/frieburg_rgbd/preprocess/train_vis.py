...
VIS_OUTPUT_DIR = BASE_DIR / "visualized_train"
...
success_count = 0
for img_path in tqdm(image_files, desc="Visualizing training images"):
    stem = img_path.stem
...
print("Open the 'visualized_train' folder in Finder to inspect.")